...
<template>
  ...
  <section id="hero">
    ...
    <p class="description">
      Die Zuflucht Ihrer Kinder im Ausland, um ihren Glauben zu bewahren
    </p>
    <p class="actions">
      <a class="get-started" href="/de/enroll">
      ...
      <a class="setup" href="/de/sponsor/">Preise ansehen</a>
    </p>
  </section>
    ...
    <div class="container">
      ...
      <div class="pricing-grid">
        <div class="pricing-card">
          ...
          <p class="plan-price"><strong>€8/Stunde</strong></p>
        </div>
        <div class="pricing-card">
          <div class="plan-icon">📅</div>
          <h3>Monthly Plan</h3>
...
.feature-card:hover {
  ...
  background: var(--vt-c-bg-soft);
  box-shadow: 0 16px 32px rgba(66, 211, 146, 0.15);
...
.approach-icon {
  ...
  margin-bottom: 24px;
  display: inline-block;
  filter: drop-shadow(0 4px 12px rgba(100, 126, 255, 0.2));
}
